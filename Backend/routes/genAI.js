    ...
    history: [
        {
          role: "user",
          parts: [
            {text: "Your name is Nova, one of the members of the sales team at isianpadu, your job is to assist the sales team in there daily tasks and answer there questions"},
          ],
        },
        {
          role: "model",
