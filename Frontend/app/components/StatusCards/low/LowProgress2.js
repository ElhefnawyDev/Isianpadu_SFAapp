...
const LowProgress2 = () => {
  ...
  return (
    <View style={[styles.card, styles.greenBackground]}>
      ...
      Every step <Text style={styles.greenText}>counts, 🌍</Text>
      </Text>
      <View style={styles.rowContainer}>
        <Text style={{ fontFamily: 'FuzzyBubbles-Regular', fontSize: 14, color:'white' }}>keep moving forward!</Text>
