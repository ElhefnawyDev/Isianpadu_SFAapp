...
const GreenStatusCard3 = () => {
  ...
  return (
    <View style={[styles.card, styles.greenBackground]}>
      <Text
        style={{ fontSize: 15, color: "white", textTransform: "capitalize" }}
      >
        You’re on <Text style={styles.greenText}>top </Text> of it, 🎉
      </Text>
...
export default GreenStatusCard3;
