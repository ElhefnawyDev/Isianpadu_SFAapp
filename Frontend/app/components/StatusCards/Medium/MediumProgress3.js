...
const MediumProgress3 = () => {
  ...
  return (
    <View style={[styles.card, styles.greenBackground]}>
      ...
      Momentum is <Text style={styles.greenText}>building,</Text>
      🔥</Text>
      <View style={styles.rowContainer}>
        <Text style={{ fontFamily: 'FuzzyBubbles-Regular', fontSize: 15, color:'white' }}>Stay on track!</Text>
...
export default MediumProgress3;
