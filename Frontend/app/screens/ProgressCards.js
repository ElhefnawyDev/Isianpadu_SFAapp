    ...
    try {
      ...
      if (info.success && Array.isArray(info.tenders)) {
        ...
        const todaySubmissionCount = filteredData.filter(
          item => item.deadline === todayDate && item.display_notice_id === 1
        ).length;
        ...
        const applicationCount = filteredData.filter(
          item => item.id_sfa_tender_category === 1 &&
                  item.delete_id === 0 &&
                  new Date(item.deadline).getFullYear() === year
        ).length;
        ...
        const mixedTenderCount = filteredData.filter(
          item => item.id_sfa_tender_category === 2 &&
                  item.delete_id === 0 &&
                  new Date(item.deadline).getFullYear() === year
        ).length;
        ...
        const hardwareTenderCount = filteredData.filter(
          item => item.id_sfa_tender_category === 3 &&
                  item.delete_id === 0 &&
                  new Date(item.deadline).getFullYear() === year
        ).length;
        ...
        const maintenanceTenderCount = filteredData.filter(
          item => item.id_sfa_tender_category === 4 &&
                  item.delete_id === 0 &&
                  new Date(item.deadline).getFullYear() === year
        ).length;
        ...
        const networkTenderCount = filteredData.filter(
          item => item.id_sfa_tender_category === 5 &&
                  item.delete_id === 0 &&
                  new Date(item.deadline).getFullYear() === year
        ).length;
        ...
        const ictInfraCount = filteredData.filter(
          item => item.id_sfa_tender_category === 6 &&
                  item.delete_id === 0 &&
                  new Date(item.deadline).getFullYear() === year
        ).length;
        ...
        const systemTenderCount = filteredData.filter(
          item => item.id_sfa_tender_category === 7 &&
                  item.delete_id === 0 &&
                  new Date(item.deadline).getFullYear() === year
        ).length;
        ...
        const softwareTenderCount = filteredData.filter(
          item => item.id_sfa_tender_category === 8 &&
                  item.delete_id === 0 &&
                  new Date(item.deadline).getFullYear() === year
        ).length;
